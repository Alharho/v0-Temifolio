    ...
    <section id="contact" className="relative py-24 sm:py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <motion.h2 
            className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold mt-3 text-white"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "0px 0px -100px 0px" }}
        ...
        >
          <motion.div
            className="backdrop-blur-md bg-white/5 rounded-2xl p-8 border border-white/10 space-y-8 hover:border-primary/20 transition-all"
            whileHover={{
          ...
          >
            ...
            <div className="space-y-6">
              {contactInfo.map((info, idx) => (
                ...
                >
                  <motion.div 
                    className="w-11 h-11 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-all"
