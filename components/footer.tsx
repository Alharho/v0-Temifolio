...
const socials = [
  {
    label: 'WhatsApp',
    href: 'https://wa.me/2347067296912',
    color: '#25D366',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/temigfx',
    color: '#1877F2',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/temigfx_',
    color: '#E4405F',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: 'Pinterest',
    href: 'https://pinterest.com/temigfx',
    color: '#E60023',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: 'Behance',
    href: 'https://behance.net/temigfx',
    color: '#1769FF',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            {socials.map(s => (
              <a
                ...
                title={s.label}
                className="w-9 h-9 rounded-lg backdrop-blur-md bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:border-white/20 hover:scale-110 transition-all"
          ...
          <p className="text-xs text-gray-500 text-center">
            &copy; {new Date().getFullYear()} Temitope J. Olalere &middot; Lagos, Nigeria
          </p>
        </div>
      </div>
    </footer>
